...
public final class Export {
    ...
    /**
     * CRILC feed — one line per large-credit borrower/group in SMA or NPA (RBI Central
     * Repository of Information on Large Credits). Aggregate exposure at/above the
     * reporting threshold with its supervisory classification + SMA bucket.
     */
    public record CrilcBorrowerLine(String borrowerRef, String name, String jurisdiction,

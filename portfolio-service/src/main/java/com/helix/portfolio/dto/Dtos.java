...
public final class Dtos {
    ...
    /** Borrowing-base / stock-statement submission for a working-capital drawing-power assessment. */
    public record BorrowingBaseRequest(String facilityRef, double stock, double debtors, double creditors,
                                       double sanctionedLimit, double outstanding, String currency) {
    }

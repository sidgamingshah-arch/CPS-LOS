...
public final class GroupDtos {
    ...
    public record GroupInsights(
            ...
            // D10 — derived GROUP grade on the AAA..D master ladder (deterministic, advisory).
            String groupGrade,
            String groupGradeMethod,        // EXPOSURE_WEIGHTED_NOTCH | WORST_OF | PARENT_ANCHORED
            String groupGradeBasis,
            List<GroupGradeContribution> groupGradeContributions,
            List<GroupMemberInsight> members,
            String narrative,
            boolean advisory) {
    }

    /** One member's contribution to the derived group grade (ladder position + exposure weight). */
    public record GroupGradeContribution(
            String counterpartyRef,
            String finalGrade,
            int notchIndex,
            double weight,

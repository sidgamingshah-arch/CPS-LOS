...
for svc in counterparty-service origination-service risk-service decision-service portfolio-service gateway-service; do
  start "$svc" "${SERVICES[$svc]}"
done

echo "All services launching. Waiting for health..."
for port in 8081 8082 8083 8084 8085 8086 8080; do
